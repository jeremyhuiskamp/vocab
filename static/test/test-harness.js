 ...
 */
export async function runAllCLI(suites) {
  ...
  console.log(`\n${'─'.repeat(40)}`);
  console.log(`${totalPassed + totalFailed} total — ${totalPassed} passed, ${totalFailed} failed`);
...
export class Harness {
  ...
  getContainer() {
    if (!this._container) {
      ...
      this._container.style.cssText = 'position:absolute;left:-9999px;height:0;overflow:hidden';
